...
def generate_mod(world, output_directory: str):
    ...
    player_names = {x: multiworld.player_names[x] for x in multiworld.player_ids}
    locations = []
    ...
    mod_name = f"AP-{multiworld.seed_name}-P{player}-{multiworld.player_names[player]}"
    ...
    template_data = {"locations": locations, "player_names": player_names, "tech_table": tech_table,
                     ...
                     "tech_cost_scale": tech_cost_scale, "custom_technologies": multiworld.autoworlds[player].custom_technologies,
                     "tech_tree_layout_prerequisites": multiworld.tech_tree_layout_prerequisites[player],
                     "slot_name": multiworld.player_names[player], "seed_name": multiworld.seed_name,
                     "starting_items": multiworld.starting_items[player], "recipes": recipes,
                     "random": random, "flop_random": flop_random,
                     "static_nodes": multiworld.autoworlds[player].static_nodes,
