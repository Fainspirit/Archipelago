...
def set_rules(world):
    ...
    set_rule(ganons_tower, lambda state: state.has_crystals(state.world.worlds[player].game_settings["crystals_needed_for_gt"], player))
...
def global_rules(world, player):
    ...
    set_rule(world.get_entrance('Sewers Door', player),
             lambda state: state._lttp_doors_has_key('Small Key (Hyrule Castle)', player) or (
                     world.worlds[player].game_settings['smallkey_shuffle'] == SmallkeyShuffle.option_universal and world.mode[
                     player] == 'standard'))  # standard universal small keys cannot access the shop
    set_rule(world.get_entrance('Sewers Back Door', player),
             lambda state: state._lttp_doors_has_key('Small Key (Hyrule Castle)', player))
    set_rule(world.get_entrance('Agahnim 1', player),
             lambda state: state.has_sword(player) and state._lttp_doors_has_key('Small Key (Agahnims Tower)', player, 2))
    ...
    set_rule(world.get_location('Castle Tower - Dark Maze', player),
             lambda state: state.can_kill_most_things(player, 8) and state._lttp_doors_has_key('Small Key (Agahnims Tower)',
                                                                                   player))
    ...
    set_rule(world.get_entrance('Desert Palace East Wing', player), lambda state: state._lttp_doors_has_key('Small Key (Desert Palace)', player))
    set_rule(world.get_location('Desert Palace - Prize', player), lambda state: state._lttp_doors_has_key('Small Key (Desert Palace)', player) and state.has('Big Key (Desert Palace)', player) and state.has_fire_source(player) and state.world.get_location('Desert Palace - Prize', player).parent_region.dungeon.boss.can_defeat(state))
    set_rule(world.get_location('Desert Palace - Boss', player), lambda state: state._lttp_doors_has_key('Small Key (Desert Palace)', player) and state.has('Big Key (Desert Palace)', player) and state.has_fire_source(player) and state.world.get_location('Desert Palace - Boss', player).parent_region.dungeon.boss.can_defeat(state))
    ...
    set_rule(world.get_entrance('Blind Fight', player), lambda state: state._lttp_doors_has_key('Small Key (Thieves Town)', player))
    set_rule(world.get_location('Thieves\' Town - Big Chest', player), lambda state: (state._lttp_doors_has_key('Small Key (Thieves Town)', player) or item_name(state, 'Thieves\' Town - Big Chest', player) == ('Small Key (Thieves Town)', player)) and state.has('Hammer', player))
    if world.accessibility[player] != 'locations':
    ...
    set_rule(world.get_location('Thieves\' Town - Attic', player), lambda state: state._lttp_doors_has_key('Small Key (Thieves Town)', player))

    set_rule(world.get_entrance('Skull Woods First Section South Door', player), lambda state: state._lttp_doors_has_key('Small Key (Skull Woods)', player))
    set_rule(world.get_entrance('Skull Woods First Section (Right) North Door', player), lambda state: state._lttp_doors_has_key('Small Key (Skull Woods)', player))
    set_rule(world.get_entrance('Skull Woods First Section West Door', player), lambda state: state._lttp_doors_has_key('Small Key (Skull Woods)', player, 2))  # ideally would only be one key, but we may have spent thst key already on escaping the right section
    set_rule(world.get_entrance('Skull Woods First Section (Left) Door to Exit', player), lambda state: state._lttp_doors_has_key('Small Key (Skull Woods)', player, 2))
    ...
    set_rule(world.get_entrance('Skull Woods Torch Room', player), lambda state: state._lttp_doors_has_key('Small Key (Skull Woods)', player, 3) and state.has('Fire Rod', player) and state.has_sword(player))  # sword required for curtain
    ...
    set_rule(world.get_location('Misery Mire - Map Chest', player), lambda state: state._lttp_doors_has_key('Small Key (Misery Mire)', player, 1) or state.has('Big Key (Misery Mire)', player))
    set_rule(world.get_location('Misery Mire - Main Lobby', player), lambda state: state._lttp_doors_has_key('Small Key (Misery Mire)', player, 1) or state._lttp_doors_has_key('Big Key (Misery Mire)', player))
    # we can place a small key in the West wing iff it also contains/blocks the Big Key, as we cannot reach and softlock with the basement key door yet
    set_rule(world.get_entrance('Misery Mire (West)', player), lambda state: state._lttp_doors_has_key('Small Key (Misery Mire)', player, 2) if ((
                                                                                                                                                 item_name(state, 'Misery Mire - Compass Chest', player) in [('Big Key (Misery Mire)', player)]) or
                                                                                                                                     (
                                                                                                                                                 item_name(state, 'Misery Mire - Big Key Chest', player) in [('Big Key (Misery Mire)', player)])) else state._lttp_doors_has_key('Small Key (Misery Mire)', player, 3))
    ...
    set_rule(world.get_entrance('Turtle Rock (Trinexx)', player), lambda state: state._lttp_doors_has_key('Small Key (Turtle Rock)', player, 4) and state.has('Big Key (Turtle Rock)', player) and state.has('Cane of Somaria', player))
    ...
    set_rule(world.get_entrance('Palace of Darkness Bridge Room', player), lambda state: state._lttp_doors_has_key('Small Key (Palace of Darkness)', player, 1))  # If we can reach any other small key door, we already have back door access to this area
    set_rule(world.get_entrance('Palace of Darkness Big Key Door', player), lambda state: state._lttp_doors_has_key('Small Key (Palace of Darkness)', player, 6) and state.has('Big Key (Palace of Darkness)', player) and state.can_shoot_arrows(player) and state.has('Hammer', player))
    set_rule(world.get_entrance('Palace of Darkness (North)', player), lambda state: state._lttp_doors_has_key('Small Key (Palace of Darkness)', player, 4))
    set_rule(world.get_location('Palace of Darkness - Big Chest', player), lambda state: state.has('Big Key (Palace of Darkness)', player))

    set_rule(world.get_entrance('Palace of Darkness Big Key Chest Staircase', player), lambda state: state._lttp_doors_has_key('Small Key (Palace of Darkness)', player, 6) or (
                item_name(state, 'Palace of Darkness - Big Key Chest', player) in [('Small Key (Palace of Darkness)', player)] and state._lttp_doors_has_key('Small Key (Palace of Darkness)', player, 3)))
    if world.accessibility[player] != 'locations':
        set_always_allow(world.get_location('Palace of Darkness - Big Key Chest', player), lambda state, item: item.name == 'Small Key (Palace of Darkness)' and item.player == player and state._lttp_doors_has_key('Small Key (Palace of Darkness)', player, 5))

    set_rule(world.get_entrance('Palace of Darkness Spike Statue Room Door', player), lambda state: state._lttp_doors_has_key('Small Key (Palace of Darkness)', player, 6) or (
                item_name(state, 'Palace of Darkness - Harmless Hellway', player) in [('Small Key (Palace of Darkness)', player)] and state._lttp_doors_has_key('Small Key (Palace of Darkness)', player, 4)))
    if world.accessibility[player] != 'locations':
        set_always_allow(world.get_location('Palace of Darkness - Harmless Hellway', player), lambda state, item: item.name == 'Small Key (Palace of Darkness)' and item.player == player and state._lttp_doors_has_key('Small Key (Palace of Darkness)', player, 5))

    set_rule(world.get_entrance('Palace of Darkness Maze Door', player), lambda state: state._lttp_doors_has_key('Small Key (Palace of Darkness)', player, 6))
    ...
    set_rule(world.get_entrance('Ganons Tower (Map Room)', player), lambda state: state._lttp_doors_has_key('Small Key (Ganons Tower)', player, 4) or (
                item_name(state, 'Ganons Tower - Map Chest', player) in [('Big Key (Ganons Tower)', player), ('Small Key (Ganons Tower)', player)] and state._lttp_doors_has_key('Small Key (Ganons Tower)', player, 3)))
    if world.accessibility[player] != 'locations':
        set_always_allow(world.get_location('Ganons Tower - Map Chest', player), lambda state, item: item.name == 'Small Key (Ganons Tower)' and item.player == player and state._lttp_doors_has_key('Small Key (Ganons Tower)', player, 3) and state.can_reach('Ganons Tower (Hookshot Room)', 'region', player))
    ...
    set_rule(world.get_entrance('Ganons Tower (Double Switch Room)', player), lambda state: state._lttp_doors_has_key('Small Key (Ganons Tower)', player, 2))
    # It is possible to need more than 3 keys ....
    set_rule(world.get_entrance('Ganons Tower (Firesnake Room)', player), lambda state: state._lttp_doors_has_key('Small Key (Ganons Tower)', player, 3))

    #The actual requirements for these rooms to avoid key-lock
    set_rule(world.get_location('Ganons Tower - Firesnake Room', player), lambda state: state._lttp_doors_has_key('Small Key (Ganons Tower)', player, 3) or ((
                                                                                                                                                             item_in_locations(state, 'Big Key (Ganons Tower)', player, zip(randomizer_room_chests, [player] * len(randomizer_room_chests))) or item_in_locations(state, 'Small Key (Ganons Tower)', player, [('Ganons Tower - Firesnake Room', player)])) and state._lttp_doors_has_key('Small Key (Ganons Tower)', player, 2)))
    for location in randomizer_room_chests:
        set_rule(world.get_location(location, player), lambda state: state._lttp_doors_has_key('Small Key (Ganons Tower)', player, 4) or (
                    item_in_locations(state, 'Big Key (Ganons Tower)', player, zip(randomizer_room_chests, [player] * len(randomizer_room_chests))) and state._lttp_doors_has_key('Small Key (Ganons Tower)', player, 3)))

    # Once again it is possible to need more than 3 keys...
    set_rule(world.get_entrance('Ganons Tower (Tile Room) Key Door', player), lambda state: state._lttp_doors_has_key('Small Key (Ganons Tower)', player, 3) and state.has('Fire Rod', player))
    # Actual requirements
    for location in compass_room_chests:
        set_rule(world.get_location(location, player), lambda state: state.has('Fire Rod', player) and (state._lttp_doors_has_key('Small Key (Ganons Tower)', player, 4) or (
                    item_in_locations(state, 'Big Key (Ganons Tower)', player, zip(compass_room_chests, [player] * len(compass_room_chests))) and state._lttp_doors_has_key('Small Key (Ganons Tower)', player, 3))))
    ...
    set_rule(world.get_location('Ganons Tower - Pre-Moldorm Chest', player),
             lambda state: state._lttp_doors_has_key('Small Key (Ganons Tower)', player, 3))
    set_rule(world.get_entrance('Ganons Tower Moldorm Door', player),
             lambda state: state._lttp_doors_has_key('Small Key (Ganons Tower)', player, 4))
...
def swordless_rules(world, player):
    set_rule(world.get_entrance('Agahnim 1', player), lambda state: (state.has('Hammer', player) or state.has('Fire Rod', player) or state.can_shoot_arrows(player) or state.has('Cane of Somaria', player)) and state._lttp_doors_has_key('Small Key (Agahnims Tower)', player, 2))
    set_rule(world.get_entrance('Skull Woods Torch Room', player), lambda state: state._lttp_doors_has_key('Small Key (Skull Woods)', player, 3) and state.has('Fire Rod', player))  # no curtain
...
def set_trock_key_rules(world, player):
    ...
    set_rule(world.get_entrance('Turtle Rock Dark Room Staircase', player), lambda state: state._lttp_doors_has_key('Small Key (Turtle Rock)', player, 3))
    ...
    if can_reach_back:
        set_rule(world.get_location('Turtle Rock - Big Key Chest', player), lambda state: (state._lttp_doors_has_key('Small Key (Turtle Rock)', player, 4) or item_name(state, 'Turtle Rock - Big Key Chest', player) == ('Small Key (Turtle Rock)', player)))
        set_rule(world.get_entrance('Turtle Rock (Chain Chomp Room) (South)', player), lambda state: state._lttp_doors_has_key('Small Key (Turtle Rock)', player, 4))
        ...
        set_rule(world.get_entrance('Turtle Rock (Chain Chomp Room) (North)', player), lambda state: state._lttp_doors_has_key('Small Key (Turtle Rock)', player, 3))
        set_rule(world.get_entrance('Turtle Rock Pokey Room', player), lambda state: state._lttp_doors_has_key('Small Key (Turtle Rock)', player, 2))
    else:
        # Middle to front requires 2 keys if the back is locked, otherwise 4
        set_rule(world.get_entrance('Turtle Rock (Chain Chomp Room) (South)', player), lambda state: state._lttp_doors_has_key('Small Key (Turtle Rock)', player, 2)
                if item_in_locations(state, 'Big Key (Turtle Rock)', player, front_locked_locations)
                else state._lttp_doors_has_key('Small Key (Turtle Rock)', player, 4))
        ...
        set_rule(world.get_entrance('Turtle Rock (Chain Chomp Room) (North)', player), lambda state: state._lttp_doors_has_key('Small Key (Turtle Rock)', player, 2))
        set_rule(world.get_entrance('Turtle Rock Pokey Room', player), lambda state: state._lttp_doors_has_key('Small Key (Turtle Rock)', player, 1))

        set_rule(world.get_location('Turtle Rock - Big Key Chest', player), lambda state: state._lttp_doors_has_key('Small Key (Turtle Rock)', player, tr_big_key_chest_keys_needed(state)))
