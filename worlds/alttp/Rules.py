...
def global_rules(world, player):
    ...
    set_rule(world.get_entrance('Sewers Door', player),
             lambda state: state._lttp_has_key('Small Key (Hyrule Castle)', player) or (
                     world.SmallkeyShuffle[player] == smallkey_shuffle.option_universal and world.mode[
    ...
    if not world.SmallkeyShuffle[player] and world.logic[player] not in ['hybridglitches', 'nologic']:
