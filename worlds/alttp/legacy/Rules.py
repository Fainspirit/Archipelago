...
from worlds.alttp.legacy.OverworldGlitchRules import overworld_glitches_rules, no_logic_rules
from worlds.alttp.legacy.UnderworldGlitchRules import underworld_glitches_rules
from worlds.alttp.legacy.Bosses import GanonDefeatRule
