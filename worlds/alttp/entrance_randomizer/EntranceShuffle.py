...
from worlds.alttp.legacy.OverworldGlitchRules import overworld_glitch_connections
from worlds.alttp.legacy.UnderworldGlitchRules import underworld_glitch_connections
